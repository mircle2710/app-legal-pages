...
| 용도 | URL |
|------|-----|
| 홈(지원) | `https://<GITHUB_USERNAME>.github.io/app-legal-pages/today-page/support.html` |
| 개인정보 | `https://<GITHUB_USERNAME>.github.io/app-legal-pages/today-page/privacy.html` |
| 이용약관 | `https://<GITHUB_USERNAME>.github.io/app-legal-pages/today-page/terms.html` |
